...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .dropdown-menu { position: relative; box-shadow: none; border: none; margin-top: 10px; background: transparent; padding-bottom: 10px;}
            .dropdown-container { padding-bottom: 1rem; }
        }
...
<body class="font-sans text-slate-800">
    ...
    <!-- Top Navigation -->
    <nav class="bg-snap-black h-[70px] w-full fixed top-0 z-50 flex items-center justify-between px-4 md:px-10 shadow-md">
        <!-- Logo -->
        ...
        <div class="flex items-center shrink-0 ml-auto">
            ...
            <!-- Language & Cart (Visible on all screens) -->
    ...
    <div id="mobile-menu" class="fixed inset-0 bg-snap-black/95 backdrop-blur-md z-[100] hidden flex-col px-6 py-8 overflow-y-auto w-full h-full">
    ...
    <div id="page-home" class="page-section page-active">
        <section class="hero-container w-full min-h-[550px] md:min-h-[650px] flex items-center relative overflow-hidden pb-16">
            ...
            <div class="max-container flex flex-col lg:flex-row items-center justify-between gap-10 z-10 w-full pt-10">
                <!-- กล่องขาวซ้ายมือ -->
                <div class="hero-white-box w-full lg:w-[520px] p-8 sm:p-10 md:p-12 relative bg-white/95 backdrop-blur-sm">
                ...
                <!-- Slide 5 ข้อความ (ปรับดีไซน์ให้อ่านง่าย พรีเมียม บนมือถือและ Desktop) -->
                <div class="flex flex-col justify-center flex-1 w-full lg:pl-16 z-10 mt-6 lg:mt-0">
    ...
    <script>
        // =========================================================================
        // JAVASCRIPT SYSTEM (STABLE VERSION 8.0 - MOBILE RESPONSIVE FIX)
        // =========================================================================
        ...
        function handleLogin() { 
            ...
            if (memoryUsers[id] === pass) {
                ...
                document.getElementById('user-section').classList.replace('hidden', 'lg:flex');
                
                // Mobile
                document.getElementById('mobile-displayUser').innerText = id;
                document.getElementById('mobile-login-section').classList.add('hidden');
                document.getElementById('mobile-login-section').classList.remove('flex');
                document.getElementById('mobile-user-section').classList.remove('hidden');
                document.getElementById('mobile-user-section').classList.add('flex');
        ...
        function handleLogout() { 
            ...
            // Desktop
            document.getElementById('user-section').classList.replace('lg:flex', 'hidden'); 
            ...
            document.getElementById('mobile-user-section').classList.remove('flex'); 
            document.getElementById('mobile-login-section').classList.remove('hidden'); 
            document.getElementById('mobile-login-section').classList.add('flex'); 
